...
backup=/Users/zuo/Marcelzuo/kalis-memory/backups/site/site-20260914-1945 · commit fcc5206
...
### 工作文件归档
- 旧版设计稿/旧博客源稿/旧 content-refresh 临时稿已移入 `/Users/zuo/kalistorik-site/_work-archive/20260914/`。
- 正式源稿保留：
  - `/Users/zuo/kalistorik-site/blog/source/*.md`
  - `/Users/zuo/kalistorik-site/content-refresh/REVIEW-NOTES.md`
  - `/Users/zuo/kalistorik-site/content-refresh/i18n/review-*.json`
- 三个审计产物保留在 `/tmp/kt-audit/`（不在 git 仓库内）。

### 下一步待办
- 决定 `_work-archive/`、`blog/source/`、`content-refresh/` 是否提交共享备份库或继续本地保留。
