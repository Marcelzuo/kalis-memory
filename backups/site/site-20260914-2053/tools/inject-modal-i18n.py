...
TRANSLATIONS = {
    "fr": {
        ...
        "qm_card2_text": "À mi-parcours de la production, nous inspectons à nouveau. Cela détecte la plupart des problèmes avant qu'ils ne se propagent.",
    ...
    "de": {
        ...
        "qm_card2_text": "Mitten in der Produktion prüfen wir erneut. Das erkennt die meisten Probleme, bevor sie sich ausbreiten.",
    ...
    "it": {
        ...
        "qm_card2_text": "A metà produzione, ispezioniamo di nuovo. Questo rileva la maggior parte dei problemi prima che si diffondano.",
    ...
    "es": {
        ...
        "qm_card2_text": "A mitad de la producción, inspeccionamos de nuevo. Esto detecta la mayoría de los problemas antes de que se extiendan.",
